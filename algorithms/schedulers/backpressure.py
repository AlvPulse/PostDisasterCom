...
class BackpressureScheduler(SchedulingAlgorithm):
    ...
    def get_active_user(self, uav, all_users):
        """Micro-step scheduling hook for Backpressure: Rate * (Q_user - Q_uav)."""
        ...
        for uid in uav.assigned_users:
            ...
            if user:
                ...
                q_diff = user.queue.total_bits - uav.queue.total_bits

                bp_weight = rate * max(0, q_diff)
